...
export const Create = () => {
  ...
  return (
    <div
      className={`animate__animated animate__slideInLeft create-main ${
        theme === "dark" ? "dark" : " "
      }`}
    >
      ...
      <div className="create-sub">
        <div className="pfp-caption">
          <img
            src="https://res.cloudinary.com/dxdsrmlcd/image/upload/v1738067039/default_profile_uj539l.png"
            alt=""
            className="create-pfp"
          />
          <input
        ...
        <div className="upload-actions">
          ...
          <button className="create-upload" onClick={handleUpload}>
            {" "}
            Upload{" "}
          </button>
        </div>
